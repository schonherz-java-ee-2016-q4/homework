package hu.schonherz.training.service.impl.multimapImpl;
...
public class MyMultiMap<K, V> implements MultiMap<K, V> {
    ...
    public Set<MultiMapNode<K, V>> entrySet() {
        return multiMapDataStructure.stream().collect(Collectors.toSet());
