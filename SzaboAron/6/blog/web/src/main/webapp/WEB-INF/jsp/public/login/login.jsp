    ...
    <div class="container">
        <nav class="blog-nav">
            ...
            <c:if test="${sessionScope.user ==null}">
                <a class="blog-nav-item active" href="<c:url value="/login/"/>">Login</a>
            </c:if>
            <c:if test="${sessionScope.user !=null}">
...
<div class="container">
    ...
    <div class="row">
        <form class="form-signin" action="<c:url value="/login/loginuser" ></c:url>" method="post">
            ...
            <label for="inputEmail" class="sr-only">Username</label> <input type="text" name="username" id="inputEmail"
                                                                            ...
                                                                            autofocus> <label
                for="inputPassword" class="sr-only">Password</label> <input type="password" name="password"
