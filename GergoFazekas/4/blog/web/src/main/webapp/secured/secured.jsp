					...
					<div class="col-lg-6">
                        <div class="input-group">
                            <input type="text" class="form-control" id="name" name="name"
                                ...
                                <button class="btn btn-success" type="button" id="searchbyname">Search by name!</button>
                            </span>
                        </div>
                        <!-- /input-group -->
                    </div>
					...
					<div class="col-lg-6">
						<div class="input-group">
							<input type="text" class="form-control" id="gender" name="gender"
								...
								class="input-group-btn">
								<button class="btn btn-default" type="button" id="searchbygender">Search by gender!</button>
							</span>
						</div>
						<!-- /input-group -->
					</div>
                    ...
                    <div class="col-lg-6">
                        <div class="input-group">
                            <input type="text" class="form-control" id="city" name="city"
                                ...
                                class="input-group-btn">
                                <button class="btn btn-success" type="button" id="searchbycity">Search by city!</button>
                            </span>
                        </div>
                        <!-- /input-group -->
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="input-group">
                            <input type="text" class="form-control" id="email" name="email"
                                ...
                                class="input-group-btn">
                                <button class="btn btn-default" type="button" id="searchbyemail">Search by email!</button>
                            </span>
                        </div>
                        <!-- /input-group -->
                    </div>
