...
<body>
	...
	<div class="container">
		...
		<div class="alert alert-info">
		  <strong>Info!</strong> To complete the registration fill all of the fields below with valid data,
		      and click on the Submit button! :)
		</div>
		<form id="registration" method="post" action="<c:url value="/Register"></c:url>">
			<div class="wellregister">
					...
					<div class="col-xs-12 col-sm-6 col-md-6">
						<div class="form-group">
							<label>Gender</label><br><label class="radio-inline"> <input
								type="radio" name="female" checked>Female
				...
				<div class="alert alert-danger" id="alertbasic">
				</div>
			</div>
			<div class="wellregister">
                ...
                <div class="alert alert-danger" id="alertlocation">
                </div>
            </div>
            <div class="wellregister">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group">
                            <label>Password again</label> <input type="password" name="password2"
                                id="password2" class="form-control input-sm"
                    ...
                    <div class="col-xs-12 col-md-4">
                        <div class="form-group">
                            <label>Large picture URL</label> <input type="text" name="large"
                                id="large" class="form-control input-sm"
                                placeholder="Large URL" required>
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-4">
                        <div class="form-group">
                            <label>Medium picture URL</label> <input type="text" name="medium"
                                id="medium" class="form-control input-sm"
                                placeholder="Medium URL" required>
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-4">
                        <div class="form-group">
                            <label>Thumbnail picture URL</label> <input type="text" name="thumbnail"
                                id="thumbnail" class="form-control input-sm"
                                placeholder="Thumbnail URL" >
                        </div>
                    </div>
                </div>
                <div class="alert alert-danger" id="alertpicture">
                asd
                </div>
            </div>
	...
	<script src="<c:url value="http://cdn.jsdelivr.net/jquery.validation/1.15.0/jquery.validate.js"/>"></script>
