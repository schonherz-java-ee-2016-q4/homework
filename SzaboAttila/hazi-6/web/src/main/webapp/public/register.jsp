	...
	<div class="container">
		...
		<div class="panel panel-default">
			...
			<form class="form-horizontal"
				action="<c:url value="/Register" ></c:url>" method="post" enctype="multipart/form-data">
				...
				<div id="uploadPanel" class="panel-body">
					...
					<div class="form-group">
						<label for="user_cell" class="col-sm-2 control-label">Upload
							Picture</label>
						<div class="col-sm-10">
							<input id="pictureSelectButton" type="file" name="file" accept="image/*">
						</div>
					</div>
			...
			<div class="panel-footer">
				...
				<ul class="pager">
					<li class="previous"><a href="#" onclick="onBack()"><span
