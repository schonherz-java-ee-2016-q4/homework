...
<template:template>
    ...
    <jsp:attribute name="customBody">
        ...
        <div class="blog-header">
            <h2 class="blog-post-title" id="post_title">Sample blog post</h2>
            <p class="blog-post-meta">
                <span id="post_date">January 1, 2014</span> by <span id="post_name"><a href="#">Mark</a></span>
            </p>
        </div>
        ...
        <div class="blog-header">
            <p class="blog-post-meta">
                Tags: <span id="post_tags">asd, asdas, adas, asd</span>
            </p>
        </div>
