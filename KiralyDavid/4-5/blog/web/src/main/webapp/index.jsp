...
<body>
 ...
 <div class="container">
  ...
  <div class="blog-header">
   <h1 class="blog-title">Hello Blog</h1>
  ...
  <div class="row">
   <c:if test="${sessionScope.user !=null}">
    <div class="panel panel-primary">
     <div class="panel-heading mypanel " id="filter_heading"
      onclick="on_header_clocked()">
      <h3>New Post</h3>

     </div>
     <div class="panel-body" id="new_post_form">
      <form class="form-horizontal" action="PostCreator" method="post"
