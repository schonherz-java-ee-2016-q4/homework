		...
		<div class="container">
			<nav class="blog-nav">
				...
				<c:if test="${sessionScope.user ==null}">
					<a class="blog-nav-item active" href="<c:url value="/public/login.jsp"/>">Login</a>
				</c:if>
				<c:if test="${sessionScope.user !=null}">
	...
	<div class="container">
		...
		<div class="row">
			<form class="form-signin" action="<c:url value="/Login" ></c:url>" method="post">
				...
				<label for="inputEmail" class="sr-only">Username</label> <input type="text" name="username" id="inputEmail" class="form-control" placeholder="Email address" required autofocus> <label
					for="inputPassword" class="sr-only">Password</label> <input type="password" name="password" id="inputPassword" class="form-control" placeholder="Password" required>
				<div class="checkbox">
