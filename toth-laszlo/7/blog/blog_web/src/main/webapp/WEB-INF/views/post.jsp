        ...
        <div class="col-xs-12 col-sm-8 col-md-8 col-sm-offset-2 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">
                        ...
                        <form  method="post" action="${pageContext.request.contextPath}/posting" name="postform" id="postform">
                      
                            <div class="form-group">
                                <label for="header">Title:</label>
                                <input type="text" name="title" id="title" class="form-control input-sm"  required="required">
                            </div>
